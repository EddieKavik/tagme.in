...
const env = {
 ...
 GEMINI_API_KEY: process.env.GEMINI_API_KEY, // Gemini API key for AI features
 TAGMEIN_LOCAL_KV: process.env.TAGMEIN_LOCAL_KV, // Use local KV for TagMeIn
 TAGMEIN_LOCAL_KV_BASEURL:
  process.env.TAGMEIN_LOCAL_KV_BASEURL, // Base URL for local KV
 PORT: 8787, // Port for the server
}
